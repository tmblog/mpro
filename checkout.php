...
function process_checkout($data) {
    ...
    $cart_validation = validate_cart_server_side($data['cart'] ?? '[]', $data['delivery_method'] ?? null);
...
function validate_checkout_form($data) {
    ...
    if ($data['order_time_type'] === 'scheduled') {
 ...
 */
function validate_cart_server_side($cart_json, $delivery_method = null) {
    ...
    foreach ($cart as $item) {
        ...
        $server_price = calculate_product_price($product_id, $converted_options);
...
function create_order($data, $customer_id, $totals, $delivery_data) {
    ...
    mysqli_stmt_bind_param($stmt, "isssssisdssddsdsssssi",
        $customer_id,
        $customer_type,
        $data['email'],
        $order_time,
