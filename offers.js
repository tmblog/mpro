...
const OffersManager = {
    ...
    updateCardState(productId, offerId, isUnlocked, claimed = false) {
        ...
        if (claimed) {
            ...
            if (requirement) requirement.innerHTML = '<span class="text-success"><i class="bi bi-check me-1"></i>Available!</span>';
        } else {
            // Locked
            ...
            if (offer && requirement) {
                ...
                requirement.textContent = `Spend £${remaining} more to add`;
            }
        }
    },
